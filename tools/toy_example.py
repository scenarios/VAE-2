...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        default='/home/yzzhou/workspace/code/video-prediction/experiments/toyexample/toyexample.yaml',
                        type=str)
...
def main():
    ...
    train_dataset = reOrg(train_dataset, 500)
    train_dataset_name = reOrg(train_dataset_name, 500)
    ...
    for epoch in range(last_epoch, end_epoch):
        ...
        if args.local_rank == 0:
            ...
            torch.save({
                'epoch': epoch + 1,
                'state_dict': model_encdec.state_dict(),
            ...
            if epoch == end_epoch - 1:
                torch.save(model_encdec.state_dict(),
